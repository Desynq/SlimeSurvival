...
public class ModifyBlockBounciness extends Power {
	private final Predicate<CachedBlockPosition> blockCondition;
	private final float bounciness;

	public ModifyBlockBounciness(PowerType<?> type, LivingEntity entity, Predicate<CachedBlockPosition> predicate, float bounciness) {
		super(type, entity);
